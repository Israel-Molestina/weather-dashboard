...
function currentSearch(value) {
  ...
  var updatedCurrentUrl =
    currentWeatherUrl + value + "&units=imperial" + "&appid=" + apiKey;
...
function currentPaste(currentJson) {
  ...
  var cityName = $("<section>").addClass(
    "flex-row gy-1 d-flex justify-content-start align-items-center"
  );
